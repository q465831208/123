...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'sap-usa.daili123.dpdns.org';            // 固定隧道域名
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYWViZTE2OGY2YmM2NmFhZThmMDcwNjY2ZWVkYmJiZDIiLCJ0IjoiYjM5ZGQwM2ItYWU0MS00MjJjLTk3ZTctNDlhOGM1ZDg4MGUyIiwicyI6Ik9EaGtaRFZsTlRRdFkyTTNaaTAwTlRsaExUa3dOVGd0TlRVM1lqSTFPREl5WkdGbSJ9';                  // 固定隧道密钥
...
// ----------------------------------------------------------------------------------------------------
// 路由设置 (修改版：原生个人主页伪装 - 集成 Gmail 和 Telegram)
// ----------------------------------------------------------------------------------------------------
